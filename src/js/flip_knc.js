...
function showAuctionDetails(id){
    ...
    msg += `- LOT: ${auction.kickLot.toLocaleString('en')} knc - BID: ${auction.bid.toLocaleString('en')} dai <br/>`;
    msg += `- KNC OSM: $${auction.kickPrice} knc/dai <br/><br/>`;
    ...
    msg += `- LOT: ${auction.lot.toLocaleString('en')} knc - BID: ${auction.bid.toLocaleString('en')} dai <br/>`;
    msg += `- PAID PRICE: $${auction.paidPrice} knc/dai <br/>`;
    msg += `- KNC OSM: $${auction.bidPrice} knc/dai <br/><br/>`;

    msg += 'Ended: <br/>';
    msg += `- DATE: ${auction.dealDate} <br/>`;
    msg += `- FROM: ${auction.txFrom} <br/>`;
    msg += `- PAID PRICE: $${auction.paidPrice} knc/dai <br/>`;
    msg += `- KNC OSM: $${auction.dealPrice} knc/dai <br/><br/>`;
