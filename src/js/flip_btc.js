...
const WBTC_FLIP_ADDRESS = "0x58CD24ac7322890382eE45A3E4F903a5B22Ee930";
...
const flipContract = new web3.eth.Contract(FLIPPER_ABI, WBTC_FLIP_ADDRESS);
...
function showAuctionDetails(id){
    ...
    msg += `- BTC MED: $${auction.kickPrice} btc/dai <br/><br/>`;
    ...
    msg += `- BTC MED: $${auction.bidPrice} btc/dai <br/><br/>`;

    msg += 'Ended: <br/>';
    msg += `- DATE: ${auction.dealDate} <br/>`;
    msg += `- FROM: ${auction.txFrom} <br/>`;
    msg += `- PAID PRICE: $${auction.paidPrice} btc/dai <br/>`;
    msg += `- BTC MED: $${auction.dealPrice} btc/dai <br/><br/>`;
