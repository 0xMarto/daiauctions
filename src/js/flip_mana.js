...
var blocksBack = 38095; // 18095 -> 3.14 days blocks count
...
function showAuctionDetails(id){
    ...
    msg += `- LOT: ${auction.kickLot.toLocaleString('en')} mana - BID: ${auction.bid.toLocaleString('en')} dai <br/>`;
    msg += `- MANA OSM: $${auction.kickPrice} mana/dai <br/><br/>`;
    ...
    msg += `- LOT: ${auction.lot.toLocaleString('en')} mana - BID: ${auction.bid.toLocaleString('en')} dai <br/>`;
    msg += `- PAID PRICE: $${auction.paidPrice} mana/dai <br/>`;
    msg += `- MANA OSM: $${auction.bidPrice} mana/dai <br/><br/>`;

    msg += 'Ended: <br/>';
    msg += `- DATE: ${auction.dealDate} <br/>`;
    msg += `- FROM: ${auction.txFrom} <br/>`;
    msg += `- PAID PRICE: $${auction.paidPrice} mana/dai <br/>`;
    msg += `- MANA OSM: $${auction.dealPrice} mana/dai <br/><br/>`;
